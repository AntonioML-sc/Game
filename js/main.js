        ...
        if (players.length == 2) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    play();  // execute the game with the chosen characters
...
const play = () => {
    ...
    const contactObjectsP1 = [players[1], floor1, wall1, wall2, wall3, platform1, wall4, wall5, platform2, wall6,
    ...
    const contactObjectsP2 = [players[0], floor1, wall1, wall2, wall3, platform1, wall4, wall5, platform2, wall6,
        floor2, wall7, wall8, wall9, wall10, wall11, platform3, platform4, platform5, wall12, wall13, platform6,
        platform7, platform8, platform9, platform10, box, platform11, platform12, platformFinal, bird1];
    ...
    function myfunction() {
        ...
        players[0].updatePos(contactObjectsP1, hazardZones, spikes, ceilingSpikes);
        players[1].updatePos(contactObjectsP2, hazardZones, spikes, ceilingSpikes);
    ...
    const p1Keydown = document.addEventListener('keydown', (event) => {
    ...
    const p1Keyup = document.addEventListener('keyup', (event) => {
        const keyName = event.key;
        if (keyName == 'd') {
            players[0].move('stop');
        }
    ...
    const p2Keydown = document.addEventListener('keydown', (event) => {
        const keyName = event.key;
    ...
    const p2Keyup = document.addEventListener('keyup', (event) => {
        const keyName = event.key;
        if (keyName == 'ArrowRight') {
            players[1].move('stop');
        }
    ...
    const exitGame = document.addEventListener('keydown', (event) => {
        const keyName = event.key;
        if (keyName == 'Escape') {
            forceExit();
        }
...
const restart = () => {
    ...
    players.forEach(ch => ch.hp = ch.maxHP);
